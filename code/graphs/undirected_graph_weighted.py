...
class GraphUndirectedWeighted(object):
    ...
    def add_edge(self, source, dest, weight):
        print(source < self.vertex_count)
        print(dest < self.vertex_count)
...
def main():
    ...
    print(shortest_path == [0, 1] and distance == 4)

    shortest_path, distance = g.dijkstra(0, 8)
    print(shortest_path == [0, 1, 2, 3, 7, 8] and distance == 11)

    shortest_path, distance = g.dijkstra(5, 0)
    print(shortest_path == [5, 3, 2, 1, 0] and distance == 9)

    shortest_path, distance = g.dijkstra(1, 1)
    print(shortest_path == [1] and distance == 0)

    msp = g.prim()
    print(msp)
    print(msp == {0: None, 1: 0, 2: 1, 3: 2, 4: 5, 5: 3, 6: 5, 7: 3, 8: 6})
