...
def test_dfs():
    ...
    c1, p1 = dg1.dfs()
    print(c1 == {0, 3, 7})
    print(p1 == {1: 0, 2: 1, 4: 2, 5: 0, 6: 2, 8: 5})
...
def test_contains_cycle():
    print(get_test_graph_1().contains_cycle() == False)
    print(get_test_graph_2().contains_cycle() == False)
    print(get_test_graph_3().contains_cycle() == False)
    print(get_test_graph_4().contains_cycle() == True)


def test_topological_sort():
    print(get_test_graph_1().topological_sort() == [7, 3, 0, 1, 2, 4, 6, 5, 8])
    print(get_test_graph_2().topological_sort() == [2, 0, 1, 3, 4, 5])
    print(get_test_graph_3().topological_sort() == [5, 3, 2, 4, 7, 8, 11])
...
def test_strongly_connected_components():
    ...
    print(components == [[10, 11, 9, 8], [7], [0], [1, 3, 2], [6, 4, 5]])
