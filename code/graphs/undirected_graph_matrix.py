...
def test_dfs_recursive():
    ...
    print(p1 == {0: 1, 1: 0, 2: 1, 3: 2, 4: 3, 5: 4, 6: 5, 7: 6, 8: 7})


def test_dfs_iterative():
    udg = get_test_graph_1()
    p1 = udg.dfs_iterative()
    print(p1 == {0: 1, 1: 0, 2: 1, 3: 7, 4: 5, 5: 6, 6: 7, 7: 1, 8: 7})


def test_bfs():
    udg = get_test_graph_1()
    p1 = udg.bfs()
    print(p1 == {0: 1, 1: 0, 2: 1, 3: 2, 4: 3, 5: 3, 6: 7, 7: 1, 8: 7})


def test_bipartite():
    udg = get_test_graph_1()
    print(udg.is_bipartite() == False)

    udg2 = get_test_graph_2()
    print (udg2.is_bipartite() == True)
